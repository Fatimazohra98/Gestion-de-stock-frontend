...
public class ArticleActivity extends AppCompatActivity {
    ...
    Retrofit retrofit = new Retrofit.Builder().baseUrl("http://192.168.1.9:8080/")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retour=findViewById(R.id.button_2);
        ajouter=findViewById(R.id.button);
        libelle=findViewById(R.id.prod_lib);
        prix=findViewById(R.id.prod_prix);
